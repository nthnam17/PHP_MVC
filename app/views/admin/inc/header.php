...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Xin Chào,
            <?php
                $adminSession = session::get('admin');
                    echo $adminSession['fullname'];
            ?>
        </a>
        ...
        <div class="navbar-nav">
            ...
            <a class="btn btn-danger py-2" href="/website__mvc/admin/loguot">Đăng Xuất</a>
            </div>
        </div>
    </header>